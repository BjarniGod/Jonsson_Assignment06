...
function introduceTheActors(actorArray)
{
        ...
        {
            //let newArray = [];
            newArray.push(`Hi, I'm ${actor.name} and I was in ${actor.movie}`)
            //console.log(`Hi, I'm ${actor.name} and I was in ${actor.movie}`);
...
introduceTheActors(actors)
  ...
  const techCompanies = 
    ...
    techCompanies.founderLookup("Apple");
  ...
  function storeFounders(founderArray)
    {
        let newArray = [];
        for(let x in founderArray)
        {
            //newArray += founderArray[x]
            newArray.push(founderArray[x])
            //console.log(`Hi, I'm ${actor.name} and I was in ${actor.movie}`);
  ...
  {
      console.log(`Time to go to ${object} class!`)
  }

  goToSecondClass(myClasses.secondHour);
